(function () {
    ...
    var admin_controller = function ($scope, assignment_service, ministry_service) {
   ...
   { value: "", text: 'Self Assigned' }
    ...
    app.controller("adminController", ["$scope","assignment_service","ministry_service", admin_controller]);
