(function () {
    ...
    var training_service = function ($http) {
        ...
        var getTrainings = function (session_ticket, ministry_id, show_all, show_tree) {
            this._apiResourceUrl = "http://localhost:52195/api/measurements/training?token=" + session_ticket + "&ministry_id=" + ministry_id + "&show_all=" + show_all + "&show_tree=" + show_tree;
        ...
        var updateTraining = function (session_ticket, training) {
            this._apiResourceUrl = "http://localhost:52195/api/measurements/training/" + training.Id + "?token=" + session_ticket;
        ...
        var addTraining = function (session_ticket, training) {
            this._apiResourceUrl = "http://localhost:52195/api/measurements/training?token=" + session_ticket;
        ...
        var addTrainingCompletion = function (session_ticket, training_completion) {
            this._apiResourceUrl = "http://localhost:52195/api/measurements/training_completion?token=" + session_ticket;
        ...
        var updateTrainingCompletion = function (session_ticket, training_completion) {
            this._apiResourceUrl = "http://localhost:52195/api/measurements/training_completion/" + training_completion.Id+ "?token=" + session_ticket;
